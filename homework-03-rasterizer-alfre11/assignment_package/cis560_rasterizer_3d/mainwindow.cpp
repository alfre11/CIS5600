...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_Escape : on_actionQuit_Esc_triggered();
        // Camera translation
    case Qt::Key_W:
        this->rasterizer.cam.translateZ(0.5);
        break;
    case Qt::Key_S:
        this->rasterizer.cam.translateZ(-0.5);
        break;
    case Qt::Key_A:
        this->rasterizer.cam.translateX(-0.5);
        break;
    case Qt::Key_D:
        this->rasterizer.cam.translateX(0.5);
        break;
    case Qt::Key_Q:
        this->rasterizer.cam.translateY(-0.5);
        break;
    case Qt::Key_E:
        this->rasterizer.cam.translateY(0.5);
        break;
        ...
        // Camera rotation
    case Qt::Key_Up:
        this->rasterizer.cam.rotateX(-5);
        break;
    case Qt::Key_Down:
        this->rasterizer.cam.rotateX(5);
        break;
    case Qt::Key_Left:
        this->rasterizer.cam.rotateY(5);
        break;
    case Qt::Key_Right:
        this->rasterizer.cam.rotateY(-5);
        break;
    case Qt::Key_Z:
        this->rasterizer.cam.rotateZ(5);
        break;
    case Qt::Key_X:
        this->rasterizer.cam.rotateZ(-5);
        break;
...
MainWindow::MainWindow(QWidget *parent) :
    ...
    rasterizer(std::vector<Polygon>(), camera)
{
    ui->setupUi(this);
...
void MainWindow::on_actionLoad_Scene_triggered()
{
    ...
    rasterizer = Rasterizer(polygons, camera);
...
void MainWindow::on_actionEquilateral_Triangle_triggered()
{
    ...
    rasterizer = Rasterizer(vec, camera);
